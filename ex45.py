...
class SpaceShip(Scene):
    ...
    def enter(self):
        ...
        print(dedent("""
            ...
            red octopus, black gooey teeth, and a eyepatch that has a laser attach to it. Brukz started 
            shooting at you. What do you do?
            """))
        ...
        if action == "Fire":
            ...
            print(dedent("""
                ...
                """)) 
            return 'SpaceshipCode'
        
        else:
            print("Ыоу аре тчоу ступид.")
            return 'SpaceShip'
...
class SpaceshipCode(Scene):
    ...
    def enter(self):
        ...
        while guess != code and guesses < 25:
            print("BZZZZEDDD!")
            guesses += 1
            guess = input("[keypad]> ")
...
class Map(object):
    ...
    scenes = {
        ...
        'Cathedral': Cathedral(),
        'UniverseDestroyed': UniverseDestroyed(),
        'finished': Finished(),
        'death': Death(), 
